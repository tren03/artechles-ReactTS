...
func TestConvert(t *testing.T) {
  ...
  },
  {
    ...
    "Body": "Cryptopals is a set of cryptography challenges that help you get hands-on with encryption techniques. These challenges start easy and get progressively harder, covering topics like AES, hashing, and public key crypto.\n\n(I kinda look it as a way to explore the language you are using, and try new libs)",
  ...
  },
  {
    ...
    for _,post := range posts_to_add{
        log.Println(reflect.TypeOf(post.Date))
    }
	if err != nil {
		println(err)
		t.Fail()
