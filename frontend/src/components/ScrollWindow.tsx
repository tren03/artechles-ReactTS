...
const ScrollWindow = () => {
                ...
                posts: [
                    {
                        ...
                        content: 'An in-depth look at how AI is shaping the future.',
                    },
                    {
                        id: 2,
                        title: 'Blockchain Basics',
                        content: 'Understanding the fundamentals of blockchain technology.',
                    },
                    {
                        id: 3,
                        title: 'Quantum Computing',
                        content: 'Exploring the potential of quantum computers.',
                    },
                    {
                        id: 4,
                        title: 'Cybersecurity Trends',
                        content: 'Top trends in cybersecurity you should know about.',
                    },
                    {
                        id: 5,
                        title: 'The Internet of Things',
                        content: 'How IoT is connecting the world.',
                    },
                ],
            },
            {
                ...
                posts: [
                    {
                        ...
                        content: "What's next for space exploration?",
                    },
                    {
                        id: 7,
                        title: 'CRISPR and Gene Editing',
                        content: 'How CRISPR is revolutionizing genetic science.',
                    },
                    {
                        id: 8,
                        title: 'Climate Change and Its Effects',
                        content: 'Understanding the global impact of climate change.',
                    },
                    {
                        id: 9,
                        title: 'Renewable Energy Advances',
                        content: 'Latest innovations in renewable energy sources.',
                    },
                    {
                        id: 10,
                        title: 'The Mysteries of Dark Matter',
                        content: 'Unraveling the secrets of dark matter.',
                    },
                ],
            },
        ],
    ...
    const transformedData = transformData(sample_api_data);
    ...
    return (
        <div className="scrollable-sidebar">
            ...
            {transformedData.categories.map((category, index) => (
                <CategoryScrollItem key={index} categoryName={category.categoryName} posts={category.posts} />
            ))}
        </div>
    );
};
